...
import { DollarSign, TrendingUp, TrendingDown, Plus, Moon, Sun, Calendar as CalendarIcon, BarChart3, PieChart } from 'lucide-react';
    ...
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'dark' : ''}`}>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Finance Tracker</h1>
              </div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mt-8">
              <Tabs defaultValue="analytics" className="space-y-6">
                <TabsList className="grid w-full grid-cols-3 bg-white dark:bg-gray-800">
                  ...
                  <TabsTrigger value="transactions" className="hover-scale">All Transactions</TabsTrigger>
                  <TabsTrigger value="bank-comparison" className="hover-scale">Bank Comparison</TabsTrigger>
                </TabsList>
          ...
          {(activeView === 'daily' || activeView === 'weekly' || activeView === 'monthly') && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2">
                <FinancialCharts transactions={transactions} period={activeView} />
              </div>
              <div>
                <ExpenseCalendar 
                  transactions={transactions} 
