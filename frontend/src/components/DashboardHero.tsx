          ...
          <CardContent className="p-8 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-green-600 dark:text-green-400">
                Track your day-to-day spending patterns
              </p>
              <Button
                variant="outline"
                className="mt-4 border-green-500 text-green-700 hover:bg-green-500 hover:text-white"
              >
                View Daily Tracker
              </Button>
            </div>
          ...
          <CardContent className="p-8 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-blue-600 dark:text-blue-400">
                Analyze your weekly financial trends
              </p>
              <Button
                variant="outline"
                className="mt-4 border-blue-500 text-blue-700 hover:bg-blue-500 hover:text-white"
              >
                View Weekly Tracker
              </Button>
            </div>
          ...
          <CardContent className="p-8 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-purple-600 dark:text-purple-400">
                Get comprehensive monthly insights
              </p>
              <Button
                variant="outline"
                className="mt-4 border-purple-500 text-purple-700 hover:bg-purple-500 hover:text-white"
              >
